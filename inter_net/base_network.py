...
class BaseModel(nn.Module):
    def __init__(self, rank, args):
        ...
        self.save_test_vis = args.save_evaluation_viz
    ...
    def train_one_epoch(self, mode, dataloader):
        self.before_train_one_epoch()
        self.train()
        log = self.run_one_epoch(mode, dataloader)
